package com.example.cherry.agri.chatbot;
...
import com.example.cherry.agri.MainActivity;
import com.example.cherry.agri.R;
...
public class ChatActivity extends AppCompatActivity {
      ...
      /*  String customFont = "Montserrat-Regular.ttf";
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new ClickListener() {
            ...
            public void onClick(View view, final int position) {
                Messages audioMessage = (Messages) messageArrayList.get(position);
    ...
    private void sendMessage() {
        ...
        if (!this.initialRequest) {
            Messages inputMessage = new Messages();
